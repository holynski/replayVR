...
class MinCompositorSequential {
 public:
  explicit MinCompositorSequential(std::shared_ptr<OpenGLContext> renderer);

  bool GetMinComposite(const Reconstruction& reconstruction,
