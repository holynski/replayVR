...
class Mesh {
 public:
  ...
  // Reads a mesh from libav's AVSphericalMesh. This data type is defined in
  // Google's Spherical Video V2 RFC spec:
  // (https://github.com/google/spatial-media/blob/master/docs/spherical-video-v2-rfc.md)
  bool LoadFromSphericalMetadata(const AVSphericalMesh& metadata);
